...
public class AboutPage {
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_email));
    ...
    public AboutPage addFacebook(String id, String title) {
        ...
        facebookElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_facebook));
    ...
    public AboutPage addTwitter(String id, String title) {
        ...
        twitterElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_twitter));
    ...
    public AboutPage addPlayStore(String id, String title) {
        ...
        playStoreElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_google_play));
    ...
    public AboutPage addYoutube(String id, String title) {
        ...
        youtubeElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_youtube));
    ...
    public AboutPage addInstagram(String id, String title) {
        ...
        instagramElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_instagram));
    ...
    public AboutPage addGitHub(String id, String title) {
        ...
        gitHubElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_github));
    ...
    public AboutPage addWebsite(String url, String title) {
        ...
        websiteElement.setIconDrawable(ContextCompat.getDrawable(mContext,R.drawable.about_icon_link));
     ...
     * @return this AboutPage instance for builder pattern support
     */
    public AboutPage setImage(Drawable resource) {
    ...
    private View createItem(final Element element) {
        ...
        if (element.getIconDrawable() != null) {
            ...
            iconView.setImageDrawable(element.getIconDrawable());
